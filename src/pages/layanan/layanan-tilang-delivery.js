...
export default function LayananTilangDelivery() {
  return (
    <>
      <Header />
      <Navbar />
        ...
        <div className="px-4 xl:px-0 xl:container mx-auto flex flex-col  md:h-max text-black">
          ...
          <div className="px-10 my-4">
            <div className="py-6 flex justify-center">
              <Image
                src="/assets/img/layanan/layanan-4/deliverytilang.jpg"
                width={1000}
                height={500}
          ...
          <h1 className="text-center font-poppins-bold text-3xl md:text-4xl mt-10 mb-4 uppercase">
            LAPORAN SKM LAYANAN DELIVERY TILANG
          </h1>

          <div className="px-10 my-4">
            <div className="py-6 flex justify-center">
              <Image
                src="/assets/img/layanan/layanan-4/SKM_DELIVERY_TILANG.jpg"
                width={1000}
                height={500}
                alt="Layanan Antar Barang Bukti"
              />
